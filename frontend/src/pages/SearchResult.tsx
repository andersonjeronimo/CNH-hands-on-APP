                    ...
                    
                    {
                        tableData.map(data => (
                            <tr className='table-primary'>
                                ...
                                <td>
                                    {
                                        data.cloudinary_secure_url ? (
                                            <img src={data.cloudinary_secure_url} width={64} className="rounded border" alt="..." />
                                        ):(
                                            <img src={avatar} width={64} className="rounded border" alt="..." />
                                        )
                                    }
                                ...
                                <td>
                                    <p className="fs-4">{data.category}</p>
                                </td>
                                <td>
                                    <a href="/#">
