            ...
            <table className="table">
                ...
                <tbody>
                    <tr className='table-success'>
                        <td>
                            <img src={aluno1} width={64} className="rounded-pill shadow" alt="..." />
                        </td>
                        <td>
                            <p className="fs-4">Thiago</p>
                        </td>
                        <td>
                    ...
                    <tr className='table-warning'>
                        <td>
                            <img src={aluna1} width={64} className="rounded-pill shadow" alt="..." />
                        </td>
                        <td>
                            <p className="fs-4">Lin</p>
                        </td>
                        <td>
                            <p className="fs-4">B</p>
                        </td>
                        <td>
                            <a href="/#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" className="bi bi-person" viewBox="0 0 16 16">
                    ...
                    <tr className='table-primary'>
                        <td>
                            <img src={aluno2} width={64} className="rounded-pill shadow" alt="..." />
                        </td>
                        <td>
                            <p className="fs-4">Jamal</p>
                        </td>
                        <td>
                            <p className="fs-4">A e B</p>
                        </td>
                        <td>
                            <a href="/#">
                                <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" className="bi bi-person" viewBox="0 0 16 16">
                    ...
                    <tr className='table-light'>
                        <td>
                            <img src={aluna2} width={64} className="rounded-pill shadow" alt="..." />
                        </td>
                        <td>
                            <p className="fs-4">Mary</p>
                        </td>
                        <td>
                            <p className="fs-4">B</p>
                        </td>
