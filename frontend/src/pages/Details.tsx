...
function Details() {
    ...
    //
    //    //Validar CPF | CNPJ
    //    const _cpf = instructorData.cpf;
    //    const _cnpj = instructorData.cnpj;
    //
    //    if (isCpf && !cpf.isValid(_cpf)) {
    //        setInputClass(inputFocusClass.danger);
    //        setAlertClass(messageClass.danger);
    //        setMessage(`Atenção: O CPF informado, ${instructorData.cpf}, é inválido`);
    //        setInstructorData(prevState => ({
    //            ...prevState,
    //            ['cpf']: ''
    //        }));
    ...
    //        setInputClass(inputFocusClass.danger);
    //        setAlertClass(messageClass.danger);
    //        setMessage(`Atenção: O CNPJ informado, ${instructorData.cnpj}, é inválido`);
    //        setInstructorData(prevState => ({
    //            ...prevState,
    //            ['cnpj']: ''
    //        }));
    ...
    //        if (isCpf) {
    //            axios.get(`${import.meta.env.VITE_INSTRUCTOR_API_CPF_URL}/${instructorData.cpf}`)
    //                .then((response) => {
    //                    if (response.data) {
    ...
    //                            setAlertClass(messageClass.danger);
    //                            setMessage(`Já existe um usuário com o CPF ${instructorData.cpf} cadastrado.`);
    //                            alert(`Já existe um usuário com o CPF ${instructorData.cpf} cadastrado.`);
    //                            setInstructorData(prevState => ({
    //                                ...prevState,
    //                                ['cpf']: ''
    //                            }));
    ...
    //                        axios.post(import.meta.env.VITE_INSTRUCTOR_API_URL, instructorData)
    //                            .then((response) => {
    ...
    //
    //        } else if (isCnpj) {
    //            axios.get(`${import.meta.env.VITE_INSTRUCTOR_API_CNPJ_URL}/${instructorData.cnpj}`)
    //                .then((response) => {
    //                    if (response.data) {
    //                        /* if (Array.isArray(response.data) && response.data.length > 0) {
    //                            setMessage('Data is a non-empty array.');
    ...
    //                            //setMessage('Data is a non-empty object.');
    //                            setAlertClass(messageClass.danger);
    //                            setMessage(`Já existe um usuário com o CNPJ ${instructorData.cnpj} cadastrado.`);
    //                            alert(`Já existe um usuário com o CNPJ ${instructorData.cnpj} cadastrado.`);
    //                            setInstructorData(prevState => ({
    //                                ...prevState,
    //                                ['cnpj']: ''
    //                            }));
    ...
    return (
        ...
        <div className="container container-fluid py-5 h-100">
            ...
            <p className="text-center"><h1>Perfil do Instrutor</h1></p>
                ...
                <div className='col-sm-12 mb-3 mb-sm-0'>
                    <div className="card" >
                        <div className="card-body text-center">
                            ...
                            <h4 className='className="mb-2'>Perfil: {userData.role}</h4>
                            <h3 className="mb-2">{instructorData.firstname} {instructorData.lastname}</h3>
                            ...
                            <div className="mb-4 pb-2">
                                <a className="link-body-emphasis" href="https://www.instagram.com/cnhnamao.2026/" target="_blank" aria-label="Instagram">
                                ...
                                <a className="link-body-emphasis" href="https://www.facebook.com/profile.php?id=61587778839563" target="_blank" aria-label="Facebook">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                                        <path fill="#039be5" d="M24 5A19 19 0 1 0 24 43A19 19 0 1 0 24 5Z"></path><path fill="#fff" d="M26.572,29.036h4.917l0.772-4.995h-5.69v-2.73c0-2.075,0.678-3.915,2.619-3.915h3.119v-4.359c-0.548-0.074-1.707-0.236-3.897-0.236c-4.573,0-7.254,2.415-7.254,7.917v3.323h-4.701v4.995h4.701v13.729C22.089,42.905,23.032,43,24,43c0.875,0,1.729-0.08,2.572-0.194V29.036z"></path>
                                    </svg>
                                </a>

                                <a className="link-body-emphasis" href="https://www.youtube.com/@CNHnaM%C3%A3o.2026" target="_blank" aria-label="Youtube">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                                        <path fill="#FF3D00" d="M43.2,33.9c-0.4,2.1-2.1,3.7-4.2,4c-3.3,0.5-8.8,1.1-15,1.1c-6.1,0-11.6-0.6-15-1.1c-2.1-0.3-3.8-1.9-4.2-4C4.4,31.6,4,28.2,4,24c0-4.2,0.4-7.6,0.8-9.9c0.4-2.1,2.1-3.7,4.2-4C12.3,9.6,17.8,9,24,9c6.2,0,11.6,0.6,15,1.1c2.1,0.3,3.8,1.9,4.2,4c0.4,2.3,0.9,5.7,0.9,9.9C44,28.2,43.6,31.6,43.2,33.9z"></path><path fill="#FFF" d="M20 31L20 17 32 24z"></path>
                                    </svg>
                                </a>

                                <a className="link-body-emphasis" href="https://x.com/CNH_na_Mao" target="_blank" aria-label="Twitter-X">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                            ...
                            <div className="row d-flex justify-content-center align-items-center">
                                <div className='col-sm-8 mb-0 mb-sm-0'>
                                    <a className="btn btn-success shadow form-control" href="https://api.whatsapp.com/send/?phone=5512988679768&text&type=phone_number&app_absent=0" target="_blank" aria-label="Whatsapp">
