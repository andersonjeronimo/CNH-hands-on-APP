...
function Details() {
    ...
    return (
        ...
        <div className="container container-fluid py-5 h-100">            
            ...
            <p className="text-center"><h1>Minha Conta</h1></p>
                ...
                <div className='col-md-12 mb-3 mb-sm-0'>
                    <div className="card">
                        <div className="card-body text-center">
                            ...
                            <h5 className='className="mb-2'>Perfil: {userData.role}</h5>
                            <h5 className="mb-2">{instructorData.firstname} {instructorData.lastname}</h5>
                            <p className="text-muted mb-4">{userData.email}<span className="mx-2">|</span>
                                ...
                                </svg> <a href="/register">Editar Conta?</a>
                            </p>
