                        ...
                        <div className="input-group mb-3">
                            {editStateField ? (
                                ...
                                <>
                                    ...
                                    <input type="text" disabled className="form-control" value={formData.state} aria-label="Recipient’s username" aria-describedby="button-addon2" />
                    ...
                    <div className='col-md-6'>
                        ...
                        <div className="input-group mb-3">
                            {editCityField ? (
                                ...
                                <>
                                    <input type="text" disabled className="form-control" value={formData.city} aria-label="Recipient’s username" aria-describedby="button-addon2" />
                        ...
                        <div className="input-group mb-3">
                            {
                                editFirstNameField ? (
                                    ...
                                    <>
                                        <input type="text" disabled className="form-control" value={formData.firstname} aria-label="Recipient’s username" aria-describedby="button-addon2" />
                        ...
                        <div className="input-group mb-3">
                            {
                                editLastNameField ? (
                                    ...
                                    <>
                                        <input type="text" disabled className="form-control" value={formData.lastname} aria-label="Recipient’s username" aria-describedby="button-addon2" />
                        ...
                        <div className="input-group mb-3">
...

                            {
                                editPhonePrefixField ? (
                                    ...
                                    <>
                                        <input type="text" disabled className="form-control" value={formData.ddd} aria-label="Recipient’s username" aria-describedby="button-addon2" />
...

                            {
                                editPhoneField ? (
                                    ...
                                    <>
                                        ...
                                        <input type="text" disabled className="form-control" value={formData.phone} aria-label="Recipient’s username" aria-describedby="button-addon2" />
