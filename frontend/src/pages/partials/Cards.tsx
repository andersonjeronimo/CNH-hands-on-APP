                            ...
                            <div className="d-grid gap-2">
                                {
                                    !role ?
                                        <button className="btn btn-primary btn-lg shadow" onClick={handleInstructorBtnClick}>
                                            Efetue Login ou Cadastre-se aqui <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
