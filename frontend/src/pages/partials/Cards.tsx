                ...
                <div className='col-md-6'>
                    <div className="card" >
                        <div className="card-body text-center">
                            ...
                            <p className="card-text fs-5">Registre-se ou, se já tiver uma conta, efetue o login</p>
                            <div className="d-grid gap-2">
                                <a href="/signin" className="btn btn-primary btn-lg shadow">
                ...
                <div className='col-md-6'>
                    <div className="card">
                        <div className="card-body text-center">
                            ...
                            <p className="card-text fs-5">Registre-se ou, se já tiver uma conta, efetue o login</p>
                            <div className="d-grid gap-2">
                                <a href="/signin" className="btn btn-success btn-lg shadow">
