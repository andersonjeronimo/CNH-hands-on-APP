            ...
            <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarNavDarkDropdown">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        {
                            (isAuth && role === utils.role.instrutor) ?
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="/privacy">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-database-fill-lock" viewBox="0 0 16 16">
                            ...
                            isAuth ?
                                <li className="nav-item">
                                    <a className="nav-link" href="#">
                                        ...
                                        </svg> <strong><i>Olá {email}</i></strong>
                                    </a>
                                </li>
                                :
                                <></>
...

                    {
                        isAuth ?
                            ...
                            <form className="form-inline my-2 my-lg-0" onSubmit={handleSubmit}>
                                <button className="btn btn-danger my-2 my-sm-0 shadow" type="submit" name="logout" id="logout">
                                    Sair <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-box-arrow-left" viewBox="0 0 16 16">
                            ...
                            <div className="my-2 my-lg-0">
                                <a href='/signin' className="btn btn-primary shadow" id="login">
                                    Entrar <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
