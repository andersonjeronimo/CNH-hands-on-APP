        ...
        <div className='container container-fluid mt-lg-5 mb-lg-5'>
            <div className='row justify-content-center'>
                <div className='col-lg-6'>
                    <div className="card mt-lg-6">
                        <div className="card-body">
                            {/* <div className="overflow-hidden rounded shadow-lg">
                                <img src={driver} className={
                                    (role && role === utils.role.aluno) ?
                                        "img-fluid grayscale h-50"
                                        :
                                        "img-fluid transition-zoom h-50"
                                }
                                        ...
                                        <>
                                            {
                                                role === utils.role.instrutor ?
                                                    <a href='/details' className="btn btn-primary btn-lg shadow">
                                                        Minha conta <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor" className="bi bi-person-lines-fill" viewBox="0 0 16 16">
...

                                {
                                    !role ?
                                        <button className="btn btn-success btn-lg shadow" onClick={handleStudenBtnClick}>
                                            Sou Aluno <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor" className="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                                                <path fill-rule="evenodd" d="M6 3.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 0-1 0v2A1.5 1.5 0 0 0 6.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-8A1.5 1.5 0 0 0 5 3.5v2a.5.5 0 0 0 1 0z" />
                                                <path fill-rule="evenodd" d="M11.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H1.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708z" />
                                            </svg>
                                        </button>
                                        ...
                                        <>
                                            {
                                                role === utils.role.aluno ?
                                                    <a href='/search' className="btn btn-success btn-lg shadow">
                                                        Encontre instrutores de trânsito <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
