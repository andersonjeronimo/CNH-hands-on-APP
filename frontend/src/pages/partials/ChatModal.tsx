                ...
                <div className="modal-content">
                    ...
                    <div className="modal-body">
                        ...
                        <div className="text-center">
                            ...
                            <img src={props.data.cloudinary_secure_url} width={156} className="rounded-pill " alt="..." />

                            <a className="link-body-emphasis" href="https://api.whatsapp.com/send/?phone=5512988679768&text&type=phone_number&app_absent=0" target="_blank" aria-label="Whatsapp">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="156" height="156" viewBox="0 0 48 48">
                    ...
                    <div className="modal-footer">
                        <button type="button" onClick={handleClick} className="btn btn-primary" data-bs-dismiss="modal">
                            Fechar <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-x-square" viewBox="0 0 16 16">
