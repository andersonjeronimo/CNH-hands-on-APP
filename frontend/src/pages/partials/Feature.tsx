            ...
            <div className="container mt-lg-5 mb-lg-5">
                ...
                <div className="row text-center">
                    <div className="col-lg-4">
                        <img src={Check} alt="check icon" className="img-fluid w-50"/>
                    ...
                    <div className="col-lg-4">
                        <img src={Chat} alt="chat icon" className="img-fluid w-50"/>
                        <p className="text-center">
                    ...
                    <div className="col-lg-4">
                        <img src={Car} alt="red car icon" className="img-fluid w-50"/>
                        <p className="text-center">
